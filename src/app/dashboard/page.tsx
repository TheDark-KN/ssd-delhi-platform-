  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="py-12 md:py-16">
        <div className="container px-4 md:px-6">
          <DashboardErrorBoundary moduleName="Dashboard Stats Cards">
          ...
          {/* Quick Actions */}
          <DashboardErrorBoundary moduleName="Quick Actions">
            <div className="mt-8">
          ...
          <DashboardErrorBoundary moduleName="My Registered Events">
            <div className="mt-8">
