...
export default function JoinPage() {
  ...
  if (submitted) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-primary to-slate-900 flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center space-y-6">
          <div className="w-24 h-24 rounded-full bg-success/20 border-2 border-success/40 flex items-center justify-center mx-auto animate-bounce">
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-5 text-left space-y-2">
            ...
            {[
              ...
              <div key={i} className="flex items-center gap-3 text-slate-400 text-sm">
                <span className="w-5 h-5 rounded-full bg-primary/50 text-white/70 text-xs flex items-center justify-center font-bold flex-shrink-0">{i + 1}</span>
                {step}
              </div>
            ))}
          </div>
  ...
  return (
    <div className="min-h-screen bg-[#4F46E5] relative overflow-hidden">
      {/* Background Effects */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-[#F59E0B]/10 blur-[120px] rounded-full" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-[#64748B]/20 blur-[120px] rounded-full" />
      </div>

      <div className="max-w-6xl mx-auto px-4 py-12 md:py-24 relative z-10">

        <div className="text-center mb-16 space-y-6">
          <Badge className="bg-[#F59E0B]/20 text-[#F59E0B] border-[#F59E0B]/30 text-[10px] font-black uppercase tracking-[0.2em] px-4 py-1.5 rounded-full">
            Join the Movement
          </Badge>
          <h1 className="text-5xl md:text-7xl font-black text-white leading-tight tracking-tight">
            Become a <span className="text-[#F59E0B]">Sainik</span>
          </h1>
          ...
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-3 text-sm font-bold text-white/80 uppercase tracking-widest">
        ...
        <div className="grid lg:grid-cols-5 gap-8 items-start">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white/5 border border-white/10 rounded-[40px] p-8 backdrop-blur-md">
              <h2 className="text-white font-black text-xs uppercase tracking-[0.2em] mb-6 flex items-center gap-2">
                <Shield className="h-4 w-4 text-[#F59E0B]" /> The Sainik Oath
              </h2>
              ...
              <div className="h-px w-12 bg-[#F59E0B] my-6" />
              <p className="text-white/80 text-xs font-bold uppercase tracking-widest">Official SSD Constitution</p>
            </div>
                  ...
                  return (
                    <button
                      ...
                      className={`w-full flex items-center gap-4 px-6 py-4 rounded-2xl text-sm font-bold text-left transition-all duration-300 border ${isSelected
                          ...
                          : "bg-white/[0.03] border-white/5 text-white/80 hover:bg-white/10 hover:border-white/20 hover:text-white"
                        }`}
                    >
                      <div className={`h-8 w-8 flex items-center justify-center rounded-xl transition-colors ${isSelected ? "bg-white/20 text-white" : "bg-white/5 text-white/80"}`}>
            ...
            {/* Contact info */}
            <div className="bg-[#F59E0B]/10 border border-[#F59E0B]/20 rounded-[32px] p-8">
              <h2 className="text-[#F59E0B] font-black text-xs uppercase tracking-[0.2em] mb-4">In-Person Applications</h2>
              <div className="flex items-start gap-4 text-white text-sm font-medium leading-relaxed">
            ...
            <div className="bg-white/5 border border-white/10 rounded-[32px] p-8 backdrop-blur-md">
              <h2 className="text-white font-black text-xs uppercase tracking-[0.2em] mb-4 flex items-center gap-2">
                <Info className="h-4 w-4 text-[#F59E0B]" /> Passport Photo Instructions
              </h2>
              <p className="text-white/70 text-xs mb-4">
                For physical ID card creation, your photo must meet these requirements:
              </p>

              <div className="space-y-3 mb-6">
                <div className="flex items-start gap-2 text-white/70 text-xs">
                  <CheckCircle className="h-3 w-3 text-success mt-0.5 flex-shrink-0" />
                  <span>White background (mandatory for ID card)</span>
                </div>
                <div className="flex items-start gap-2 text-white/70 text-xs">
                  <CheckCircle className="h-3 w-3 text-success mt-0.5 flex-shrink-0" />
                  <span>Clear face, no sunglasses or accessories</span>
                </div>
                <div className="flex items-start gap-2 text-white/70 text-xs">
                  <CheckCircle className="h-3 w-3 text-success mt-0.5 flex-shrink-0" />
                  <span>Recent photo (not more than 3 months old)</span>
                </div>
                <div className="flex items-start gap-2 text-white/70 text-xs">
                  <CheckCircle className="h-3 w-3 text-success mt-0.5 flex-shrink-0" />
                  <span>Proper lighting with no shadows</span>
                </div>
              </div>

              <div className="grid grid-cols-2 gap-3 mb-6">
                <div className="text-center">
                  <div className="border-2 border-success/50 rounded-xl overflow-hidden">
                    <img
                      src="/currect_passpor_photho.jpg"
                      alt="Correct passport photo example 1"
                      className="w-full h-auto"
                    />
                  </div>
                  <p className="text-success text-[10px] font-bold mt-2">Correct Format</p>
                </div>
                <div className="text-center">
                  <div className="border-2 border-success/50 rounded-xl overflow-hidden">
                    <img
                      src="/currect_passpor_dwar.jpg"
                      alt="Correct passport photo example 2"
                      className="w-full h-auto"
                    />
                  </div>
                  <p className="text-success text-[10px] font-bold mt-2">Correct Format</p>
              ...
              <div className="bg-error/10 border border-error/30 rounded-xl p-4">
                <div className="flex items-start gap-2 text-error">
                  ...
                  <div>
                    <p className="text-error text-xs font-bold">Important Data Warning</p>
                    <p className="text-error/70 text-[10px] mt-1">
                      Any data that does not match your Aadhaar records will be restricted for SSD Delhi membership in the future. Please ensure all information provided matches your official documents.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-[48px] p-8 md:p-12 shadow-2xl overflow-hidden relative group">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#F59E0B]/5 rounded-bl-[100px] pointer-events-none" />

              {draftRestored && (
                <div className="mb-4 bg-success/10 border border-success/30 rounded-xl p-3 flex items-center gap-3">
              ...
              <h2 className="text-2xl font-black text-[#4F46E5] mb-8">Membership Application</h2>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                <div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs font-black text-[#64748B] uppercase tracking-widest mb-2">Full Name *</label>
                      <input
                        {...register("name")}
                        placeholder="e.g. Rajesh Kumar"
                        className="w-full px-5 py-4 text-sm bg-slate-50 border-2 border-slate-50 rounded-2xl text-[#4F46E5] placeholder:text-slate-400 focus:outline-none focus:border-[#F59E0B]/30 focus:bg-white transition-all font-bold"
                      />
                      {errors.name && <p className="text-error text-xs mt-2 font-bold">{errors.name.message}</p>}
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2.5 text-sm bg-white/5 border border-white/10 rounded-xl text-white placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all"
                      />
                      {errors.occupation && <p className="text-error text-xs mt-1">{errors.occupation.message}</p>}
                    </div>
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-9 pr-4 py-2.5 text-sm bg-white/5 border border-white/10 rounded-xl text-white placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all"
                        />
                      </div>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      <div>
                        ...
                        <input
                          {...register("city")}
                          placeholder="Delhi"
                          className="w-full px-3 py-2.5 text-sm bg-white/5 border border-white/10 rounded-xl text-white placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all"
                        />
                ...
                <div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 text-sm bg-white/5 border border-white/10 rounded-xl text-white placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all resize-none"
                    />
                    {errors.reason && <p className="text-error text-xs mt-1">{errors.reason.message}</p>}
                  </div>
                </div>

                {/* Oath Agreement */}
                <div className="bg-muted0/5 border border-primary/20 rounded-xl p-4">
                  ...
                  {errors.agreement && <p className="text-error text-xs mt-2 ml-7">{errors.agreement.message}</p>}
                </div>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 px-8 py-5 bg-[#F59E0B] hover:bg-[#D97706] disabled:opacity-50 disabled:cursor-not-allowed text-white font-black text-sm uppercase tracking-widest rounded-2xl transition-all duration-300 shadow-xl shadow-[#F59E0B]/20 hover:shadow-[#F59E0B]/40 active:scale-[0.98]"
                >
                  {isSubmitting ? (
