          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white/5 border border-white/10 rounded-[32px] p-8 backdrop-blur-md">
              <h2 className="text-white font-black text-xs uppercase tracking-[0.2em] mb-4 flex items-center gap-2">
                <Info className="h-4 w-4 text-[#FFDA78]" /> Passport Photo Instructions
              </h2>
              <p className="text-blue-100/70 text-xs mb-4">
                For physical ID card creation, your photo must meet these requirements:
              </p>
              
              <div className="space-y-3 mb-6">
                <div className="flex items-start gap-2 text-blue-100/70 text-xs">
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                <div className="text-center">
                  <div className="border-2 border-green-400/50 rounded-xl overflow-hidden">
                    <img
                  ...
                  <p className="text-green-400 text-[10px] font-bold mt-2">Correct Format</p>
                </div>
                <div className="text-center">
                  <div className="border-2 border-green-400/50 rounded-xl overflow-hidden">
                    <img
              ...
              <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-4">
                <div className="flex items-start gap-2 text-red-300">
                  ...
                  <div>
                    <p className="text-red-200 text-xs font-bold">Important Data Warning</p>
