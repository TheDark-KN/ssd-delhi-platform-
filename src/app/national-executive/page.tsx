...
export default function NationalExecutivePage() {
  return (
    <div className="min-h-screen bg-background">
      <section className="relative overflow-hidden bg-blue-deep px-4 pb-28 pt-20 text-white md:px-6 md:pb-40 md:pt-28">
        <div className="absolute -left-20 -top-24 h-72 w-72 rounded-full bg-saffron/20 blur-3xl" />
        <div className="absolute -bottom-40 right-0 h-96 w-96 rounded-full bg-[#2A629A]/40 blur-3xl" />
        <div className="container relative">
          <div className="max-w-4xl">
            <div className="mb-7 flex items-center gap-3 text-saffron">
            ...
            <h1 className="text-4xl font-black leading-tight tracking-tight md:text-7xl">
              National Executive <span className="text-saffron">/ Office Bearers List</span>
            </h1>
            ...
            <div className="mt-8 flex flex-wrap gap-3 text-sm font-bold text-blue-100">
              <span className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-2">
                <span className="h-4 w-4 text-saffron" aria-hidden="true">👥</span>
                National Executive
              </span>
