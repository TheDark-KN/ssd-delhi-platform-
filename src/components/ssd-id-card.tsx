  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <div className="bg-gradient-to-r from-[#4F46E5] to-[#64748B] p-6 text-white relative overflow-hidden">
          {/* Background Pattern */}
          ...
          <div className="relative z-10 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-white/80 font-medium">Delhi Chapter • Ambedkar Jayanti 2026</p>
              </div>
            </div>
            <Badge className="bg-[#F59E0B] text-white font-bold text-xs px-3 py-1.5 rounded-full">
              EVENT PASS
            </Badge>
          </div>
        </div>
        ...
        <CardContent className="p-0">
          <div className="grid md:grid-cols-3 gap-0">
            {/* Photo Section */}
            <div className="bg-gradient-to-br from-muted to-primary/10 p-6 flex flex-col items-center justify-center border-r border-border">
              ...
              <Badge className="bg-[#4F46E5] text-white font-bold text-xs px-4 py-1.5 rounded-full mb-2">
                {roleInEvent}
              </Badge>
            ...
            <div className="md:col-span-2 p-6 space-y-4">
              ...
              <div className="bg-gradient-to-r from-[#F59E0B] to-[#FFE09A] rounded-2xl p-4 text-center border-2 border-[#F59E0B]">
                <p className="text-xs font-bold text-[#4F46E5] uppercase tracking-widest mb-1">SSD Member ID</p>
                <p className="text-2xl md:text-3xl font-black text-[#4F46E5] tracking-tight">{ssdId}</p>
              </div>
              ...
              <div className="pt-3 border-t border-gray-100">
                ...
                <p className="text-sm font-bold text-[#4F46E5] truncate">{email}</p>
              </div>
            </div>
          </div>

          {/* Footer - QR Code & Validation */}
          <div className="bg-gradient-to-r from-gray-50 to-muted p-4 border-t border-gray-100">
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-bold text-[#4F46E5] uppercase tracking-wider">Scan to Verify</p>
              ...
              <div className="flex items-center gap-4 text-xs">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-[#4F46E5]">14 Apr 2026</span>
                </div>
                <div className="flex items-center gap-2">
                  <MapPin className="w-4 h-4 text-[#F59E0B]" />
                  <span className="font-bold text-[#4F46E5]">Ambedkar Bhawan</span>
                </div>
              </div>

              {/* Validity Badge */}
              <div className="flex items-center gap-2 bg-success/10 px-3 py-2 rounded-xl">
          ...
          <div className="bg-[#4F46E5] px-6 py-3 text-center">
            <p className="text-xs font-bold text-[#F59E0B] uppercase tracking-[0.3em]">
      ...
      <div className="flex justify-center gap-4 mt-6 print:hidden">
        <Button
          ...
          className="bg-[#4F46E5] hover:bg-[#4338CA] text-white font-bold rounded-full px-8 py-6 shadow-lg shadow-[#4F46E5]/30"
        >
        ...
        <Button
          ...
          variant="outline"
          className="border-2 border-[#4F46E5] text-[#4F46E5] hover:bg-[#4F46E5] hover:text-white font-bold rounded-full px-8 py-6"
        >
          Print ID Card
        </Button>
      </div>
